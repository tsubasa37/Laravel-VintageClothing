                                ...
                                <form action="{{ route('admin.users.update',['user' => $user->id]) }}" method="POST">
                                    ...
                                    <div class="-m-2">
                                        ...
                                        <div class="p-2 w-full flex justify-around mt-4">
                                            <button type="button" onclick="location.href='{{ route('admin.users.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">戻る</button>
